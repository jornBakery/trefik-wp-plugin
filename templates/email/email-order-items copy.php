                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pc-w620-spacing-15-16-0-0 pc-w620-align-left"
                                                                ...
                                                                ?>
                                                                <!-- <img src="images/image-1746645680083.png" class="pc-w620-width-64 pc-w620-height-64 pc-w620-width-64-min pc-w620-align-left" width="100" height="104" alt="" style="display: block; outline: 0; line-height: 100%; -ms-interpolation-mode: bicubic; width: 100px; height: 104px; border: 0;" /> -->
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </th>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td valign="top"
                                                                                                    ...
                                                                                                    <div class="pc-font-alt pc-w620-textAlign-left"
                                                                                                        ...
                                                                                                        <div
                                                                                                            style="font-size:16px;mso-line-height-alt:26px;line-height:26px;text-align:left;text-align-last:left;color:#ec7e30;font-weight:500;font-style:normal;">
                                                                                                            <div>
                                                                                                                <span
                                                                                                                    style="font-family: 'Rubik', Arial, Helvetica, sans-serif; font-size: 20px; line-height: 140%; letter-spacing: -0.03em;"
                                                                                                                    class="pc-w620-font-size-16px pc-w620-line-height-26px">
                                                                                                                    <?php
                                                                                                                        // Product name.
                                                                                            ...
                                                                                            <tr>
                                                                                                <td valign="top"
                                                                                                    ...
                                                                                                    <div class="pc-font-alt pc-w620-textAlign-left"
                                                                                                        style="text-decoration: none;">
                                                                                                        <div
                                                                                                            style="font-size:16px;mso-line-height-alt:20px;line-height:20px;text-align:left;text-align-last:left;color:#001942;font-weight:700;font-style:normal;">
                                                                                                            <div>
                                                                                                                <span
                                                                                                                    style="font-family: 'DM Sans', Arial, Helvetica, sans-serif; font-size: 16px; line-height: 140%; letter-spacing: -0.03em;"
                                                                                                                    class="pc-w620-font-size-16px pc-w620-line-height-20px">
                                                                                                                ...
                                                                                                                <span
                                                                                                                    style="font-family: 'DM Sans', Arial, Helvetica, sans-serif; font-weight: 400; font-size: 16px; line-height: 140%; letter-spacing: -0.03em;">
                                                                                                                    KEY-681b8a96a31bf
                                                                                                                </span>
                                                                                                                <span
                                                                                                                    style="font-family: 'DM Sans', Arial, Helvetica, sans-serif; font-size: 16px; line-height: 140%; letter-spacing: -0.03em; font-weight: 400;"
                                                                                ...
                                                                                <tr>
                                                                                    <th valign="top"
                                                                                        ...
                                                                                        <a class="pc-w620-textAlign-left"
                                                                                            ...
                                                                                            target="_blank">
                                                                                            <span
                                                                                                style="font-size:17px;mso-line-height-alt:24px;line-height:24px;color:#ffffff;letter-spacing:-0.2px;font-weight:600;font-style:normal;display:inline-block;vertical-align:top;">
                                                                                                <span
                                                                                                    style="display:inline-block;">
                                                                                                    <span
                                                                                                        style="font-family: 'DM Sans', Arial, Helvetica, sans-serif; font-size: 17px; line-height: 24px;">
                                                                                                        24 uur
                                                                                                    </span>
                                                                                                </span>
                                                                                            </span>
            ...
            <td valign="top" align="left">
                <div class="pc-font-alt" style="text-decoration: none;">
                    <div
                        ...
                        <div>
                            <span
                                style="font-family: 'Rubik', Arial, Helvetica, sans-serif; font-size: 15px; line-height: 140%; letter-spacing: -0.03em;">
                                <?php
